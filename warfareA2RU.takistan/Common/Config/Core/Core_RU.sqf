...
_c = _c + ['RU_Soldier_AT'];
_i = _i + [['','',310,5,-1,3,0,0.9,'Russians',[]]];

_c = _c + ['RU_Soldier_HAT'];
_i = _i + [['','',895,6,-1,3,0,0.92,'Russians',[]]];
...
_i = _i + [['','',295,5,-1,2,0,0.94,'Russians',[]]];
...
_c = _c + ['KamazRepair'];
_i = _i + [['','',3000,21,-2,0,1,0,'Russians',[]]];
...
_i = _i + [['','',8500,25,-2,0,1,0,'Russians',[]]];

_c = _c + ['GAZ_Vodnik'];
_i = _i + [['','',850,22,-2,0,1,0,'Russians',[]]];

_c = _c + ['GAZ_Vodnik_HMG'];
_i = _i + [['','',1450,24,2,1,1,0,'Russians',[]]];

_c = _c + ['BTR90'];
_i = _i + [['','',3250,25,-2,3,1,0,'Russians',[]]];

_c = _c + ['GRAD_RU'];
_i = _i + [['','',12500,25,-2,3,1,0,'Russians',[]]];
...
_i = _i + [['','',11000,35,-2,0,3,0,'Russians',[]]];

_c = _c + ['Mi17_rockets_RU'];
_i = _i + [['','',22000,45,-2,1,3,0,'Russians',[]]];

_c = _c + ['Mi24_P'];
_i = _i + [['','',32800,52,-2,2,3,0,'Russians',[]]];

_c = _c + ['Mi24_V'];
_i = _i + [['','',37000,50,-2,2,3,0,'Russians',[]]];

_c = _c + ['Su34'];
_i = _i + [['','',58000,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Su39'];
_i = _i + [['','',56500,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Ka52'];
_i = _i + [['','',44000,55,-2,3,3,0,'Russians',[]]];

_c = _c + ['Ka52Black'];
_i = _i + [['','',44000,55,-2,3,3,0,'Russians',[]]];

//_c = _c + ['Ka60_GL_RU'];
//_i = _i + [['','',44000,55,2,2,3,0,'Russians']];

//_c = _c + ['Ka52'];
//_i = _i + [['','',if (paramBalancing) then {44500} else {52500},55,2,2,3,0,'Russians']];
...
_c = _c + ['D30_RU'];
_i = _i + [['','',2500,0,1,0,'Defense',0,'Russians',[]]];
