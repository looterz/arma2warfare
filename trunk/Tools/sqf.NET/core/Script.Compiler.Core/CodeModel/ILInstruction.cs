    ...
    public partial class ILInstruction
    {
        ...
        */
        ...
        public OpCode OpCodeLookup(ref byte[] x)
        {
            ...
            throw new InvalidOperationException("OpCode not found: " + id.ToString("x4"));
        }
        ...
        public static ILInstruction[] GetILAsInstructionArray(MethodBase b)
        {
            ...
            ILInstruction[] n = InternalReadIL(b, x);

            // do we need to revert to legacy add/remove event implementation?

            if (b.Name.StartsWith("add_") || b.Name.StartsWith("remove_"))
                if (n.Length == 25)
                {
                    if (
                        ...
                        && n[14].OpCode == OpCodes.Call
                        && n[23].OpCode == OpCodes.Brtrue_S)
                    {



                        /*
                        +		[0]	{[0x0000] ldarg.0    +1 -0}	jsc.ILInstruction
                        +		[1]	{[0x0001] ldfld      +1 -1}	jsc.ILInstruction
                        +		[2]	{[0x0006] stloc.0    +0 -1}	jsc.ILInstruction
                        +		[3]	{[0x0007] ldloc.0    +1 -0}	jsc.ILInstruction
                        +		[4]	{[0x0008] stloc.1    +0 -1}	jsc.ILInstruction
                        +		[5]	{[0x0009] ldloc.1    +1 -0}	jsc.ILInstruction
                        +		[6]	{[0x000a] ldarg.1    +1 -0}	jsc.ILInstruction
                        +		[7]	{[0x000b] call       +1 -2}	jsc.ILInstruction
                        +		[8]	{[0x0010] castclass  +1 -1}	jsc.ILInstruction
                        +		[9]	{[0x0015] stloc.2    +0 -1}	jsc.ILInstruction
                        +		[10]	{[0x0016] ldarg.0    +1 -0}	jsc.ILInstruction
                        +		[11]	{[0x0017] ldflda     +1 -1}	jsc.ILInstruction
                        +		[12]	{[0x001c] ldloc.2    +1 -0}	jsc.ILInstruction
                        +		[13]	{[0x001d] ldloc.1    +1 -0}	jsc.ILInstruction
                        +		[14]	{[0x001e] call       +1 -3}	jsc.ILInstruction
                        +		[15]	{[0x0023] stloc.0    +0 -1}	jsc.ILInstruction
                        +		[16]	{[0x0024] ldloc.0    +1 -0}	jsc.ILInstruction
                        +		[17]	{[0x0025] ldloc.1    +1 -0}	jsc.ILInstruction
                        +		[18]	{[0x0026] ceq        +1 -2}	jsc.ILInstruction
                        +		[19]	{[0x0028] ldc.i4.0   +1 -0}	jsc.ILInstruction
                        +		[20]	{[0x0029] ceq        +1 -2}	jsc.ILInstruction
                        +		[21]	{[0x002b] stloc.3    +0 -1}	jsc.ILInstruction
                        +		[22]	{[0x002c] ldloc.3    +1 -0}	jsc.ILInstruction
                        +		[23]	{[0x002d] brtrue.s   +0 -1}	jsc.ILInstruction
                        +		[24]	{[0x002f] ret        +0 -0}	jsc.ILInstruction
                        ...
                        n[1].OpParam.CopyTo(code, 0x04);
                        n[7].OpParam.CopyTo(code, 0x0a);
                        n[8].OpParam.CopyTo(code, 0x0f);
                        n[1].OpParam.CopyTo(code, 0x14);

                        n = InternalReadIL(b, code);
                    }
                }
        ...
        private static ILInstruction[] InternalReadIL(MethodBase b, byte[] xx)
        {
            var x = xx;
