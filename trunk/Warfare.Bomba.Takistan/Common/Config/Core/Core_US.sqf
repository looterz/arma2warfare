...
_i = _i + [['','',350,15,1,0,1,0,'US']];

_c = _c + ['HMMWV_Terminal_EP1'];
_i = _i + [['','',400,15,1,0,1,0,'US']];
...
_i = _i + [['','',525,22,1,1,1,0,'US']];

_c = _c + ['MtvrReammo_DES_EP1'];
_i = _i + [['','',550,22,1,1,1,0,'US']];

_c = _c + ['MtvrRefuel_DES_EP1'];
_i = _i + [['','',500,22,1,1,1,0,'US']];

_c = _c + ['MtvrSupply_DES_EP1'];
_i = _i + [['','',550,25,1,0,1,0,'US']];

/* Heavy Vehicles */
_c = _c + ['M1126_ICV_M2_EP1'];
_i = _i + [['','',2650,25,2,1,1,0,'US']];

_c = _c + ['M1126_ICV_mk19_EP1'];
_i = _i + [['','',2950,25,2,1,1,0,'US']];

_c = _c + ['M1129_MC_EP1'];
_i = _i + [['','',2300,25,2,1,1,0,'US']];
...
_i = _i + [['','',6975,40,3,2,2,0,'US']];

_c = _c + ['MLRS_DES_EP1'];
_i = _i + [['','',6800,40,2,3,2,0,'US']];

_c = _c + ['M1A2_US_TUSK_MG_EP1'];
_i = _i + [['','',8925,40,3,3,2,0,'US']];
...
/* Air Vehicles */
_c = _c + ['MH6J_EP1'];
_i = _i + [['','',6750,35,1,0,3,0,'US']];

_c = _c + ['UH60M_EP1'];
_i = _i + [['','',7500,35,2,0,3,0,'US']];

_c = _c + ['UH60M_MEV_EP1'];
_i = _i + [['','',8250,35,1,0,3,0,'US']];

_c = _c + ['CH_47F_EP1'];
_i = _i + [['','',7500,40,2,0,3,0,'US']];

_c = _c + ['C130J_US_EP1'];
_i = _i + [['','',15000,55,1,1,3,0,'US']];

_c = _c + ['C130J'];
_i = _i + [['','',15000,55,1,1,3,0,'US']];

_c = _c + ['AH6J_EP1'];
_i = _i + [['','',19500,50,1,1,3,0,'US']];

_c = _c + ['AH64D_EP1'];
_i = _i + [['','',35000,60,2,2,3,0,'US']];
...
for '_z' from 0 to (count _c)-1 do {
	if (isClass (configFile >> 'CfgVehicles' >> (_c select _z))) then {
		...
		format["Core_US: Duplicated Element found '%1'",(_c select _z)] call LogHigh;
		};
	} else {
		format["Core_US: Element '%1' is not a valid class.",(_c select _z)] call LogHigh;
	};
};

Format ["Core_US: Initialization (%1 Elements) - [Done]",count _c] call LogMedium;