...
_c = _c + ['M1A1'];
_i = _i + [['','',6975,40,3,if (WF_A2_Vanilla) then {1} else {2},2,0,'USMC']];

_c = _c + ['MLRS'];
_i = _i + [['','',5800,40,2,3,2,0,'USMC']];

_c = _c + ['M1A2_TUSK_MG'];
_i = _i + [['','',8925,40,3,if (WF_A2_Vanilla) then {2} else {3},2,0,'USMC']];

/* Air Vehicles */
_c = _c + ['MH60S'];
_i = _i + [['','',7500,35,2,0,3,0,'USMC']];
...
_c = _c + ['C130J'];
_i = _i + [['','',15000,55,1,1,3,0,'USMC']];

_c = _c + ['AH1Z'];
_i = _i + [['','',39500,68,2,2,3,0,'USMC']];

_c = _c + ['AH64D'];
_i = _i + [['','',35000,60,2,2,3,0,'USMC']];

_c = _c + ['F35B'];
_i = _i + [['','',48000,62,1,3,3,0,'USMC']];

_c = _c + ['AV8B'];
_i = _i + [['','',58875,62,1,3,3,0,'USMC']];

_c = _c + ['AV8B2'];
_i = _i + [['','',63750,65,1,3,3,0,'USMC']];
...
for '_z' from 0 to (count _c)-1 do {
	if (isClass (configFile >> 'CfgVehicles' >> (_c select _z))) then {
		...
		format["Core_USMC: Duplicated Element found '%1'",(_c select _z)] call LogHigh;
		};
	} else {
		format["Core_USMC: Element '%1' is not a valid class.",(_c select _z)] call LogHigh;
	};
};
