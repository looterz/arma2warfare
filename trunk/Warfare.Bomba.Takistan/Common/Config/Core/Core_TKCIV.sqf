...
_i = _i + [['','',50,8,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Old_moto_TK_Civ_EP1'];
_i = _i + [['','',100,12,1,0,1,0,'Takistani Civilians']];

_c = _c + ['TT650_TK_CIV_EP1'];
_i = _i + [['','',110,15,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Lada1_TK_CIV_EP1'];
_i = _i + [['','',175,18,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Lada2_TK_CIV_EP1'];
_i = _i + [['','',175,18,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Volha_1_TK_CIV_EP1'];
_i = _i + [['','',200,21,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Volha_2_TK_CIV_EP1'];
_i = _i + [['','',200,21,1,0,1,0,'Takistani Civilians']];

_c = _c + ['VolhaLimo_TK_CIV_EP1'];
_i = _i + [['','',200,22,1,0,1,0,'Takistani Civilians']];

_c = _c + ['LandRover_TK_CIV_EP1'];
_i = _i + [['','',250,24,1,0,1,0,'Takistani Civilians']];

_c = _c + ['S1203_TK_CIV_EP1'];
_i = _i + [['','',320,25,1,0,1,0,'Takistani Civilians']];

_c = _c + ['V3S_Open_TK_CIV_EP1'];
_i = _i + [['','',380,25,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Ural_TK_CIV_EP1'];
_i = _i + [['','',390,25,1,0,1,0,'Takistani Civilians']];

_c = _c + ['Ikarus_TK_CIV_EP1'];
_i = _i + [['','',420,25,1,0,1,0,'Takistani Civilians']];
...
for '_z' from 0 to (count _c)-1 do {
	if (isClass (configFile >> 'CfgVehicles' >> (_c select _z))) then {
		...
		format["Core_TKCIV: Duplicated Element found '%1'",(_c select _z)] call LogHigh;
		};
	} else {
		format["Core_TKCIV: Element '%1' is not a valid class.",(_c select _z)] call LogHigh;
	};
};

Format ["Core_TKCIV: Initialization (%1 Elements) - [Done]",count _c] call LogMedium;