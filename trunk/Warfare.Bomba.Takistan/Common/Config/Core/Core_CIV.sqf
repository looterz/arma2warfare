...
/* Light Vehicles */
_c = _c + ['MMT_Civ'];
_i = _i + [['','',50,8,1,0,1,0,'Civilians']];

_c = _c + ['TT650_Civ'];
_i = _i + [['','',100,12,1,0,1,0,'Civilians']];

_c = _c + ['Tractor'];
_i = _i + [['','',150,15,1,0,1,0,'Civilians']];

_c = _c + ['Lada1'];
_i = _i + [['','',175,18,1,0,1,0,'Civilians']];

_c = _c + ['Lada2'];
_i = _i + [['','',175,18,1,0,1,0,'Civilians']];

_c = _c + ['LadaLM'];
_i = _i + [['','',180,20,1,0,1,0,'Civilians']];

_c = _c + ['SkodaBlue'];
_i = _i + [['','',190,17,1,0,1,0,'Civilians']];

_c = _c + ['SkodaRed'];
_i = _i + [['','',190,17,1,0,1,0,'Civilians']];

_c = _c + ['car_sedan'];
_i = _i + [['','',200,20,1,0,1,0,'Civilians']];

_c = _c + ['car_hatchback'];
_i = _i + [['','',220,20,1,0,1,0,'Civilians']];

_c = _c + ['datsun1_civil_1_open'];
_i = _i + [['','',250,22,1,0,1,0,'Civilians']];
...
_c = _c + ['VWGolf'];
_i = _i + [['','',270,23,1,0,1,0,'Civilians']];

_c = _c + ['hilux1_civil_1_open'];
_i = _i + [['','',340,25,1,0,1,0,'Civilians']];

_c = _c + ['hilux1_civil_2_covered'];
_i = _i + [['','',340,25,1,0,1,0,'Civilians']];

_c = _c + ['V3S_Civ'];
_i = _i + [['','',380,22,1,0,1,0,'Civilians']];

_c = _c + ['UralCivil'];
_i = _i + [['','',390,25,1,0,1,0,'Civilians']];

_c = _c + ['Ikarus'];
_i = _i + [['','',420,25,1,0,1,0,'Civilians']];
...
for '_z' from 0 to (count _c)-1 do {
	if (isClass (configFile >> 'CfgVehicles' >> (_c select _z))) then {
		...
		format["Core_CIV: Duplicated Element found '%1'",(_c select _z)] call LogHigh;
		};
	} else {
		format["Core_CIV: Element '%1' is not a valid class.",(_c select _z)] call LogHigh;
	};
};

Format ["Core_CIV: Initialization (%1 Elements) - [Done]",count _c]  call LogMedium;