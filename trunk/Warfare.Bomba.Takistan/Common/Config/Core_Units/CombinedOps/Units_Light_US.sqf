...
if (paramDLCBAF) then {
	_u = _u		+ [['BAF_Offroad_W', 'BAF_Offroad_D']];
	_u = _u		+ [['BAF_Jackal2_GMG_W', 'BAF_Jackal2_GMG_D']];
	_u = _u		+ [['BAF_Jackal2_L2A1_W', 'BAF_Jackal2_L2A1_D']];
};

if (paramDLCPMC) then {		
	_u = _u		+ ['SUV_PMC', 'SUV_PMC_BAF'];
