...
_u = _u + ['SMAW_HEAA'];
_i = _i + [['','','CfgMagazines','secondary',175,2,false,false,0,0,true]];

_u = _u + ['SMAW_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',150,2,false,false,0,0,true]];
...
_u = _u + ['MP5SD'];
_i = _i + [['','','CfgWeapons','',90,1,true,false,0,0,true]];
