private['_c','_u','_longestlightbuildtime'];

/* WEST - Light */
_u = Call Compile preprocessFile (WFBE_V_UnitsRoot + WFBE_V_West_UnitsRootVersion + 'Units_Light_' + WFBE_V_West_Faction + '.sqf');
...
/* EAST - Light */
_u = Call Compile preprocessFile (WFBE_V_UnitsRoot + WFBE_V_East_UnitsRootVersion + 'Units_Light_' + WFBE_V_East_Faction + '.sqf');
...
/* RESISTANCE - Light */
_u = Call Compile preprocessFile (WFBE_V_UnitsRoot + WFBE_V_Resistance_UnitsRootVersion + 'Units_Light_' + WFBE_V_Resistance_Faction + '.sqf');
