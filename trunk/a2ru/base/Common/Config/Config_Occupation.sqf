...
diag_log Format["[WFBE (INIT)][frameno:%1 | ticktime:%2] Config_Occupation: Intialization of Occupation West: '%3', East: '%4' - [Done]",diag_frameno,diag_tickTime,_occTypeWest,_occTypeEast];