...
switch (_localize) do {
	...
	case "HeadHunterReceiveBounty": {_txt = Format [Localize "STR_WF_HeadHunterReceiveBounty",_this select 1,_this select 2];(_this select 1) Call ChangePlayerFunds;_commandChat = false;};
};
