...
_probaOccupation = 75;
if (_supplyValue <= _oc1) then {_type = ["SmallTeam","SmallTeam"];_probaOccupation = 95};
if ((_supplyValue >= _oc1)&&(_supplyValue < _oc2)) then {_type = ["SmallTeam","SmallTeam","SmallVehTeam"];_probaOccupation = 90};
if ((_supplyValue >= _oc2)&&(_supplyValue < _oc3)) then {_type = ["SmallTeam","MediumTeam","SmallVehTeam"];_probaOccupation = 85};
