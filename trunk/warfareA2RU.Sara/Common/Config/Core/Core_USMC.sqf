...
_c = _c + ['AH1Z'];
_i = _i + [['','',45500,68,2,2,3,0,'USMC']];

_c = _c + ['AH64D'];
_i = _i + [['','',49000,60,2,2,3,0,'USMC']];

_c = _c + ['F35B'];
_i = _i + [['','',52000,62,1,3,3,0,'USMC']];

_c = _c + ['AV8B'];
_i = _i + [['','',53250,62,1,3,3,0,'USMC']];

_c = _c + ['AV8B2'];
_i = _i + [['','',55500,65,1,3,3,0,'USMC']];

_c = _c + ['A10'];
_i = _i + [['','',54500,65,1,3,3,0,'USMC']];
