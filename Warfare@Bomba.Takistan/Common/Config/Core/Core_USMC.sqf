...
_c = _c + ['HMMWV'];
_i = _i + [['','',200,15,1,0,1,0,'USMC']];

_c = _c + ['Zodiac'];
_i = _i + [['','',225,17,1,0,1,0,'USMC']];

_c = _c + ['HMMWV_M2'];
_i = _i + [['','',500,18,2,0,1,0,'USMC']];

_c = _c + ['HMMWV_Armored'];
_i = _i + [['','',550,20,2,1,1,0,'USMC']];

_c = _c + ['HMMWV_MK19'];
_i = _i + [['','',700,22,2,1,1,0,'USMC']];

_c = _c + ['HMMWV_TOW'];
_i = _i + [['','',850,20,2,2,1,0,'USMC']];

_c = _c + ['HMMWV_Avenger'];
_i = _i + [['','',1200,25,2,2,1,0,'USMC']];

_c = _c + ['HMMWV_Ambulance'];
_i = _i + [['','',350,22,1,2,1,0,'USMC']];

_c = _c + ['MTVR'];
_i = _i + [['','',300,20,1,0,1,0,'USMC']];

_c = _c + ['MtvrRepair'];
_i = _i + [['','',425,22,1,0,1,0,'USMC']];

_c = _c + ['WarfareReammoTruck_USMC'];
_i = _i + [['','',450,22,1,1,1,0,'USMC']];

_c = _c + ['MtvrRefuel'];
_i = _i + [['','',400,22,1,1,1,0,'USMC']];

_c = _c + ['WarfareSupplyTruck_USMC'];
_i = _i + [['','',450,25,1,0,1,0,'USMC']];

_c = _c + ['RHIB'];
_i = _i + [['','',750,25,2,1,1,0,'USMC']];

_c = _c + ['RHIB2Turret'];
_i = _i + [['','',950,27,2,2,1,0,'USMC']];

_c = _c + ['LAV25'];
_i = _i + [['','',1250,27,3,3,1,0,'USMC']];

/* Heavy Vehicles */
_c = _c + ['AAV'];
_i = _i + [['','',1550,25,3,0,2,0,'USMC']];

_c = _c + ['M1A1'];
_i = _i + [['','',4650,40,3,2,2,0,'USMC']];

_c = _c + ['MLRS'];
_i = _i + [['','',4800,40,2,3,2,0,'USMC']];

_c = _c + ['M1A2_TUSK_MG'];
_i = _i + [['','',5950,40,3,3,2,0,'USMC']];

/* Air Vehicles */
_c = _c + ['MH60S'];
_i = _i + [['','',5000,35,2,0,3,0,'USMC']];

_c = _c + ['UH1Y'];
_i = _i + [['','',8000,40,2,1,3,0,'USMC']];

_c = _c + ['MV22'];
_i = _i + [['','',9000,40,1,1,3,0,'USMC']];

_c = _c + ['C130J'];
_i = _i + [['','',10000,55,1,1,3,0,'USMC']];

_c = _c + ['AH1Z'];
_i = _i + [['','',33000,68,2,2,3,0,'USMC']];

_c = _c + ['AH64D'];
_i = _i + [['','',30000,60,2,2,3,0,'USMC']];

_c = _c + ['F35B'];
_i = _i + [['','',40000,62,1,3,3,0,'USMC']];

_c = _c + ['AV8B'];
_i = _i + [['','',39250,62,1,3,3,0,'USMC']];

_c = _c + ['AV8B2'];
_i = _i + [['','',42500,65,1,3,3,0,'USMC']];
...
for '_z' from 0 to (count _c)-1 do {
	...
	if (isNil '_get') then {
		...
		Format ["Core_USMC: Duplicated Element found '%1'",(_c select _z)] call LogMedium;
	};
};

Format ["Core_USMC: Initialization (%1 Elements) - [Done]",count _c] call LogMedium;