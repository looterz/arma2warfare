...
if (!paramArtyComputer && !WF_A2_Vanilla) then {Call Compile "enableEngineArtillery false;"};
...
{Call Compile Format ["%1 = nil",_x]} forEach ['WFBE_V_West_UnitsRootVersion','WFBE_V_East_UnitsRootVersion','WFBE_V_Resistance_UnitsRootVersion','WFBE_V_West_Faction',
'WFBE_V_East_Faction','WFBE_V_Resistance_Faction','WFBE_V_East_SquadsFaction','WFBE_V_West_SquadsFaction','WFBE_V_East_SquadsRootVersion','WFBE_V_West_SquadsRootVersion','WFBE_V_East_Loadout',
'WFBE_V_West_Loadout','WFBE_V_East_LoadoutRootVersion','WFBE_V_West_LoadoutRootVersion'];