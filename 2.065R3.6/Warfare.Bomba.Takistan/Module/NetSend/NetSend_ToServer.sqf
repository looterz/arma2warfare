...
PROFILER_BEGIN("NetSend_ToServer");
	...
	format["NetSend_ToServer: ServerChannelName '%1'", WBE_NETSEND_SERVERID] call LogHigh;
	...
	} else 
	{
		...
		call compile format["NETSEND_MSG%1=_this; publicVariable 'NETSEND_MSG%1';", WBE_NETSEND_SERVERID];
