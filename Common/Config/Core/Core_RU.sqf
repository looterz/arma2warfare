...
/* Light Vehicles */
_c = _c + ['UAZ_RU'];
_i = _i + [['','',200,15,1,0,1,0,'Russians']];

_c = _c + ['PBX'];
_i = _i + [['','',225,15,1,0,1,0,'Russians']];

_c = _c + ['UAZ_AGS30_RU'];
_i = _i + [['','',420,18,1,1,1,0,'Russians']];

_c = _c + ['Kamaz'];
_i = _i + [['','',300,15,1,0,1,0,'Russians']];

_c = _c + ['KamazRepair'];
_i = _i + [['','',425,21,1,0,1,0,'Russians']];

_c = _c + ['WarfareReammoTruck_RU'];
_i = _i + [['','',450,21,1,1,1,0,'Russians']];

_c = _c + ['KamazRefuel'];
_i = _i + [['','',400,21,1,1,1,0,'Russians']];

_c = _c + ['WarfareSupplyTruck_RU'];
_i = _i + [['','',450,21,1,0,1,0,'Russians']];

_c = _c + ['GAZ_Vodnik_MedEvac'];
_i = _i + [['','',425,25,1,2,1,0,'Russians']];

_c = _c + ['GAZ_Vodnik'];
_i = _i + [['','',1000,22,2,2,1,0,'Russians']];

_c = _c + ['GAZ_Vodnik_HMG'];
_i = _i + [['','',1250,24,2,3,1,0,'Russians']];

_c = _c + ['BTR90'];
_i = _i + [['','',1950,25,3,3,1,0,'Russians']];

_c = _c + ['GRAD_RU'];
_i = _i + [['','',3900,25,2,3,1,0,'Russians']];

/* Heavy Vehicles */
_c = _c + ['BMP3'];
_i = _i + [['','',2400,35,3,2,2,0,'Russians']];

_c = _c + ['T72_RU'];
_i = _i + [['','',3900,40,3,2,2,0,'Russians']];

_c = _c + ['T90'];
_i = _i + [['','',5250,40,3,3,2,0,'Russians']];

_c = _c + ['2S6M_Tunguska'];
_i = _i + [['','',7800,35,3,3,2,0,'Russians']];

/* Air Vehicles */
_c = _c + ['Mi17_medevac_RU'];
_i = _i + [['','',5500,35,1,0,3,0,'Russians']];

_c = _c + ['Mi17_rockets_RU'];
_i = _i + [['','',23500,45,2,1,3,0,'Russians']];

_c = _c + ['Mi24_V'];
_i = _i + [['','',24800,50,2,2,3,0,'Russians']];

_c = _c + ['Mi24_P'];
_i = _i + [['','',26700,52,2,2,3,0,'Russians']];

_c = _c + ['Su34'];
_i = _i + [['','',45000,55,2,3,3,0,'Russians']];

_c = _c + ['Su39'];
_i = _i + [['','',42400,55,1,3,3,0,'Russians']];

_c = _c + ['Ka52'];
_i = _i + [['','',29000,55,2,2,3,0,'Russians']];

_c = _c + ['Ka52Black'];
_i = _i + [['','',32000,55,2,2,3,0,'Russians']];
