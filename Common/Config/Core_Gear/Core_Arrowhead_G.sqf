...
_u = _u + ['6Rnd_HE_M203'];
_i = _i + [['','','CfgMagazines','primary',40,0,true,false,0,0]];
...
_i = _i + [['','','CfgMagazines','primary',35,0,true,false,0,0]];
...
_u = _u + ['MAAWS_HEAT'];
_i = _i + [['','','CfgMagazines','secondary',180,2,false,false,0,0]];

_u = _u + ['MAAWS_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',200,2,false,false,0,0]];
...
_u = _u + ['10x_303'];
_i = _i + [['','','CfgMagazines','primary',2,0,true,false,0,0]];
...
_u = _u + ['Dragon_EP1'];
_i = _i + [['','','CfgMagazines','secondary',220,1,false,false,0,0]];
...
_i = _i + [['','','CfgMagazines','sidearm',4,0,true,true,0,0]];

_u = _u + ['30Rnd_9x19_UZI'];
_i = _i + [['','','CfgMagazines','sidearm',4,0,true,true,0,0]];

_u = _u + ['30Rnd_9x19_UZI_SD'];
_i = _i + [['','','CfgMagazines','sidearm',6,0,true,true,0,0]];
...
_u = _u + ['M249_TWS_EP1'];
_i = _i + [['','','CfgWeapons','',285,3,false,false,0,0]];
...
_u = _u + ['M110_NVG_EP1'];
_i = _i + [['','','CfgWeapons','',290,2,false,false,0,0]];

_u = _u + ['SCAR_L_CQC'];
_i = _i + [['','','CfgWeapons','',190,0,true,false,0,0]];

_u = _u + ['SCAR_L_CQC_Holo'];
_i = _i + [['','','CfgWeapons','',210,1,true,false,0,0]];
...
_i = _i + [['','','CfgWeapons','',345,3,true,false,0,0]];

_u = _u + ['SCAR_L_STD_HOLO'];
_i = _i + [['','','CfgWeapons','',215,1,true,false,0,0]];

_u = _u + ['SCAR_H_CQC_CCO'];
_i = _i + [['','','CfgWeapons','',225,1,true,false,0,0]];
...
_i = _i + [['','','CfgWeapons','',275,2,true,false,0,0]];
...
_u = _u + ['MAAWS'];
_i = _i + [['','','CfgWeapons','',375,2,false,false,0,0]];

_u = _u + ['Stinger'];
_i = _i + [['','','CfgWeapons','',250,2,false,false,0,0]];

_u = _u + ['US_Assault_Pack_EP1'];
_i = _i + [['','','CfgVehicles','',80,1,true,false,0,0]];

_u = _u + ['US_Patrol_Pack_EP1'];
_i = _i + [['','','CfgVehicles','',70,0,true,false,0,0]];

_u = _u + ['US_Backpack_EP1'];
_i = _i + [['','','CfgVehicles','',90,2,true,false,0,0]];

_u = _u + ['Tripod_Bag'];
_i = _i + [['','','CfgVehicles','',90,2,false,false,0,0]];

_u = _u + ['M2HD_mini_TriPod_US_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',155,0,false,false,0,0]];

_u = _u + ['M2StaticMG_US_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',190,0,false,false,0,0]];

_u = _u + ['MK19_TriPod_US_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',450,1,false,false,0,0]];

_u = _u + ['TOW_TriPod_US_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',600,2,false,false,0,0]];

_u = _u + ['M252_US_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',750,1,false,false,0,0]];
...
_i = _i + [['','','CfgWeapons','',275,2,false,false,0,0]];
...
_u = _u + ['Tripod_Bag'];
_i = _i + [['','','CfgVehicles','',40,0,false,false,0,0]];
...
_i = _i + [['','','CfgVehicles','',410,1,false,false,0,0]];

_u = _u + ['AGS_TK_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',490,1,false,false,0,0]];
...
_u = _u + ['glock17_EP1'];
_i = _i + [['','','CfgWeapons','',35,1,true,false,0,0]];
...
_u = _u + ['revolver_EP1'];
_i = _i + [['','','CfgWeapons','',10,0,true,false,0,0]];

_u = _u + ['revolver_gold_EP1'];
_i = _i + [['','','CfgWeapons','',10,1,true,false,0,0]];

_u = _u + ['Sa61_EP1'];
_i = _i + [['','','CfgWeapons','',25,0,true,false,0,0]];

_u = _u + ['UZI_EP1'];
_i = _i + [['','','CfgWeapons','',55,1,true,false,0,0]];

_u = _u + ['UZI_SD_EP1'];
_i = _i + [['','','CfgWeapons','',65,2,true,false,0,0]];
...
_i = _i + [['','','CfgWeapons','Special',50,1,true,false,0,0]];
