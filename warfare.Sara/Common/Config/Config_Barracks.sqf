Private['_c','_longestBarracksBuildTime','_resType','_u'];
...
/* RESISTANCE - Barracks */
_u = Call Compile preprocessFile Format["Common\Config\Core_Units\%1\Units_Barracks_%2.sqf",WFBE_V_Resistance_UnitsRootVersion,WFBE_V_Resistance_Faction];
