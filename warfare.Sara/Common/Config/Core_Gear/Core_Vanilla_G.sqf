...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgMagazines','secondary',475,3,false,false,0,0,true]];

_u = _u + ['M136'];
_i = _i + [['','','CfgMagazines','secondary',50,0,true,false,0,0,true]];

_u = _u + ['SMAW_HEAA'];
_i = _i + [['','','CfgMagazines','secondary',350,2,false,false,0,0,true]];

_u = _u + ['SMAW_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',390,3,false,false,0,0,true]];
...
_u = _u + ['AT13'];
_i = _i + [['','','CfgMagazines','secondary',325,3,false,false,0,0,true]];
...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgWeapons','',750,3,false,false,0,0,false]];
...
_u = _u + ['SMAW'];
_i = _i + [['','','CfgWeapons','',490,2,false,false,0,0,false]];
...
_u = _u + ['MetisLauncher'];
_i = _i + [['','','CfgWeapons','',520,3,false,false,0,0,false]];
