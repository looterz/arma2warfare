...
_i = _i + [['','',2650,25,2,0,2,0,'US']];

_c = _c + ['M1126_ICV_mk19_EP1'];
_i = _i + [['','',2950,25,2,0,2,0,'US']];

_c = _c + ['M1129_MC_EP1'];
_i = _i + [['','',2300,25,2,1,2,0,'US']];

_c = _c + ['M1135_ATGMV_EP1'];
_i = _i + [['','',2850,25,2,2,2,0,'US']];

_c = _c + ['M1128_MGS_EP1'];
_i = _i + [['','',3650,25,2,2,2,0,'US']];

_c = _c + ['M1133_MEV_EP1'];
_i = _i + [['','',2950,25,1,1,2,0,'US']];

_c = _c + ['M2A2_EP1'];
_i = _i + [['','',4450,30,3,1,2,0,'US']];

_c = _c + ['M2A3_EP1'];
_i = _i + [['','',4950,32,3,2,2,0,'US']];

_c = _c + ['M1A1_US_DES_EP1'];
_i = _i + [['','',5650,40,3,2,2,0,'US']];

_c = _c + ['MLRS_DES_EP1'];
_i = _i + [['','',6800,40,2,3,2,0,'US']];

_c = _c + ['M1A2_US_TUSK_MG_EP1'];
_i = _i + [['','',6950,40,3,3,2,0,'US']];

_c = _c + ['M6_EP1'];
_i = _i + [['','',8200,35,3,3,2,0,'US']];

/* Air Vehicles */
_c = _c + ['MH6J_EP1'];
_i = _i + [['','',8500,35,1,0,3,0,'US']];

_c = _c + ['UH60M_EP1'];
_i = _i + [['','',9000,35,2,0,3,0,'US']];

_c = _c + ['UH60M_MEV_EP1'];
_i = _i + [['','',9500,35,1,0,3,0,'US']];

_c = _c + ['CH_47F_EP1'];
_i = _i + [['','',10000,40,2,0,3,0,'US']];

_c = _c + ['C130J_US_EP1'];
_i = _i + [['','',12500,55,1,1,3,0,'US']];

_c = _c + ['AH6J_EP1'];
_i = _i + [['','',24500,50,1,1,3,0,'US']];

_c = _c + ['AH64D_EP1'];
_i = _i + [['','',49000,60,2,2,3,0,'US']];

_c = _c + ['A10_US_EP1'];
_i = _i + [['','',54500,65,1,3,3,0,'US']];
