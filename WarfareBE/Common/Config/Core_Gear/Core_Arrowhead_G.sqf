...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgMagazines','secondary',300,3,false,false,0,0,true]];

_u = _u + ['M136'];
_i = _i + [['','','CfgMagazines','secondary',50,0,true,false,0,0,true]];

_u = _u + ['MAAWS_HEAT'];
_i = _i + [['','','CfgMagazines','secondary',180,2,false,false,0,0,true]];

_u = _u + ['MAAWS_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',200,2,false,false,0,0,true]];
...
_u = _u + ['AT13'];
_i = _i + [['','','CfgMagazines','secondary',200,3,false,false,0,0,true]];

_u = _u + ['Dragon_EP1'];
_i = _i + [['','','CfgMagazines','secondary',220,1,false,false,0,0,true]];

_u = _u + ['Igla'];
_i = _i + [['','','CfgMagazines','secondary',110,2,false,false,0,0,true]];

_u = _u + ['OG7'];
_i = _i + [['','','CfgMagazines','secondary',95,1,false,false,0,0,true]];
...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgWeapons','',600,3,false,false,0,0,false]];

_u = _u + ['Laserdesignator'];
_i = _i + [['','','CfgWeapons','',275,3,true,false,0,0,true]];

_u = _u + ['M136'];
_i = _i + [['','','CfgWeapons','',75,0,true,false,0,0,false]];

_u = _u + ['MAAWS'];
_i = _i + [['','','CfgWeapons','',375,2,false,false,0,0,false]];
...
_u = _u + ['RPG7V'];
_i = _i + [['','','CfgWeapons','',125,0,true,false,0,0,false]];

_u = _u + ['RPG18'];
_i = _i + [['','','CfgWeapons','',90,0,true,false,0,0,false]];
...
_u = _u + ['UZI_EP1'];
_i = _i + [['','','CfgWeapons','',55,1,true,false,0,0,true]];

_u = _u + ['UZI_SD_EP1'];
_i = _i + [['','','CfgWeapons','',65,2,true,false,0,0,true]];
...
_u = _u + ['MineE'];
_i = _i + [['','','CfgMagazines','CfgMagazines',40,0,true,true,0,0,true]];
