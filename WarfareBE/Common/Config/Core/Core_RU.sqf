...
_i = _i + [['','',26500,45,2,1,3,0,'Russians']];

_c = _c + ['Mi24_V'];
_i = _i + [['','',26800,50,2,2,3,0,'Russians']];

_c = _c + ['Mi24_P'];
_i = _i + [['','',28700,52,2,2,3,0,'Russians']];

_c = _c + ['Su34'];
_i = _i + [['','',45500,55,2,2,3,0,'Russians']];

_c = _c + ['Su39'];
_i = _i + [['','',46400,55,1,3,3,0,'Russians']];

_c = _c + ['Ka52'];
_i = _i + [['','',if (paramBalancing) then {39500} else {49500},55,2,3,3,0,'Russians']];
