private['_targetX','_targetY','_relTX','_relTY','_relUX','_relUY','_waiting','_pursue','_react','_newpos','_currPos','_orgPos','_targetPos','_attackPos','_flankPos','_avoidPos','_speedmode','_npc','_ucthis','_members','_closeenough','_areamarker','_orgmode','_destname','_initpos','_centerpos','_newunit','_exit','_rangex','_currcycle','_trackername','_trgname','_centerx','_centery','_rangey','_orgspeed','_c','_friendlytanks','_isplane','_areadir','_track','_isman','_areasize','_try','_bldpos','_maxcopies','_swimming','_e','_obj','_isboat','_sharedenemy','_opfknowval','_orignowp','_mincopies','_a','_surrended','_issoldier','_area','_fm','_lastknown','_pause','_cycle','_markerobj','_markertype','_deletedead','_flgname','_tries','_road','_showmarker','_cosdir','_sindir','_lastdamage','_nofollow','_shareinfo','_areatrigger','_noslow','_posinfo','_markercolor','_zoneempty','_trgside','_loop','_dp','_friends','_enemies','_mindist','_orgdir','_copies','_groupone','_grpname','_iscar','_orgwatch','_maxmove','_moved','_damm','_dammchg','_lastdamm','_hitpos','_sin0','_sin90','_cos90','_sin270','_cos270','_nul','_currx','_curry','_speed','_drydist'];
...
// create the clones
	for "_grpcnt" from 1 to _copies do {
		...
		_nul=[_lead,_areamarker,_pause,_noslow,_nomove,_nofollow,_initpos,_track,_showmarker,_shareinfo,"DELETE:",_deletedead] Spawn UPSMON;
		//sleep .05;
	};	
	processInitCommands;
	sleep .05;
