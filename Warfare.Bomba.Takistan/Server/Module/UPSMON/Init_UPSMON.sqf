private['_bi','_targetpos','_bz','_auxtarget'];
...
"KRON_UPS_EAST_SURRENDED" addPublicVariableEventHandler { if (_this select 1) then { nul=[east] Spawn "Server\Module\UPSMON\UPSMON\MON_surrended.sqf";};};
...
//Time that leader wait until doing another movement, this time reduced dinamically under fire, and on new targets
KRON_UPS_react = 60;
