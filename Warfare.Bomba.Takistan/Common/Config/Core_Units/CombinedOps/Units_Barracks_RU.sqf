...
_u = _u		+ [['RU_Soldier_Medic', 'TK_Soldier_Medic_EP1']];
_u = _u		+ [['RU_Soldier_SL', 'TK_Soldier_SL_EP1']];
_u = _u		+ [['RU_Soldier_Crew', 'TK_Soldier_Crew_EP1']];
_u = _u		+ [['RU_Soldier_Pilot', 'TK_Soldier_Pilot_EP1']];

_u = _u		+ [['RUS_Commander', 'TK_Soldier_Officer_EP1']];
_u = _u		+ [['TK_Soldier_Engineer_EP1']];

if (paramExtraUnits) then {
	_u = _u		+ [['RU_Soldier2', 'TK_Soldier_EP1' ]];
	_u = _u		+ [['RU_Soldier_TL']];
	_u = _u		+ [['RUS_Soldier']];	
	_u = _u		+ [['RUS_Soldier1']];
	_u = _u		+ [['RUS_Soldier2']];
