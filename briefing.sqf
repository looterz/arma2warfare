//--- Author [ICE]
player createDiaryRecord["Diary", ["Bomba What News", "<br/>- Added ability to sell and buy supplies in central depot of any captured cities<br/>- The possibility to build a static defences in the town for any player<br/>
- Increase factories strength to x5 (Saboteurs cant now destroy all base with use 5 SMAW shells, 5 SMAW for one builing is required)<br/>- Buy tanks, light, and solidirs in central depot of any captured city<br/>"]];
